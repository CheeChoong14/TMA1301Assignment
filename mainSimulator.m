function output=mainSimulator()
    ...
    valid=0;
    sv1_counterNumberUsed=input('How many counters for checkout service are open?: ');
    while (valid==0)%Error checking
        if(sv1_counterNumberUsed<1||sv1_counterNumberUsed>3)
    ...
    valid=0;
    printf('Total of 3 counters for checkout service are available');
    sv2_counterNumberUsed=input('How many counters for express checkout service are open?: ');
    while (valid==0)%Error checking
